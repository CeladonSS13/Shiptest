...
/obj/item/areaeditor/blueprints
	...
	icon = 'icons/obj/items.dmi'
	icon_state = "blueprints"
	fluffnotice = "Property of Nanotrasen. For heads of staff only. Store in high-secure storage." // [CELADON-EDIT]
...
/obj/item/areaeditor/blueprints/cyborg
	...
	icon = 'icons/obj/items.dmi'
	icon_state = "blueprints"
	fluffnotice = "Intellectual Property of Nanotrasen. For use in engineering cyborgs only. Wipe from memory upon departure from company ownership." // [CELADON-EDIT]
