	...
	if(user.is_holding(src))
		if(!lit)
			...
			if(fancy)
				...
				playsound(src.loc, pick('sound/items/zippo_on.ogg', 'mod_celadon/_storage_sounds/sound/effects/zippo_on.ogg'), 100, 1) // [CELADON-EDIT] - CELADON_ITEMS
			else
				var/prot = FALSE
			...
			if(fancy)
				...
				playsound(src.loc, pick('sound/items/zippo_off.ogg', 'mod_celadon/_storage_sounds/sound/effects/zippo_off.ogg'), 100, 1) // [CELADON-EDIT] - CELADON_ITEMS
			else
