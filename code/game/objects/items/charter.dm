...
/obj/item/sector_charter/Initialize()
	. = ..()
...
/obj/item/sector_charter/attack_self(mob/living/user)
	if(used)
...
/obj/item/sector_charter/flag/rename_station(designation, uname, ureal_name, ukey)
