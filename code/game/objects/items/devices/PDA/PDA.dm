...
// [/CELADON-ADD]
			...
			if(6)
				...
				dat += "<i>Thank you for choosing ExperTrak® brand software! ExperTrak® inc. is proud to be a Makosso-Warra employee expertise and effectiveness department subsidary!</i>"
				dat += "<br><br>This software is designed to track and monitor your skill development as a Makosso-Warra employee. Your job performance across different fields has been quantified and categorized below.<br>"
