...
/world/proc/SetupLogs()
	...
	GLOB.world_economic_log = "[GLOB.log_directory]/economic.log" // [CELADON-ADD] - CELADON_COMPONENTS_LOGS
	...
	start_log(GLOB.world_economic_log) // [CELADON-ADD] - CELADON_COMPONENTS_LOGS
