...
// gun related stuff  end
			...
			//[CELADON-ADD] - CELADON_WEAPONS, CELADON_RETURN_CONTENT_CLOWNS - добавляем рандомизацию звуков при выстреле
			if("svd_fire")
			...
			//[/CELADON-ADD] - CELADON_WEAPONS, CELADON_RETURN_CONTENT_CLOWNS
	return soundin
