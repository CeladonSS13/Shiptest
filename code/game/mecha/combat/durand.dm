/obj/mecha/combat/durand
	desc = "An aging and extremely well-armored combat exosuit utilized by the Nanotrasen corporation. Originally developed to combat hostile alien lifeforms." // [CELADON-EDIT]
