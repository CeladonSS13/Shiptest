...
/obj/item/mecha_parts/mecha_equipment/conversion_kit/mp_gygax
	name = "NT-501p-MP Conversion Kit" // [CELADON-EDIT]
	desc = "A Nanotrasen made conversion kit for a 501p combat exosuit, to convert it to the lightweight NT-501p-MP skirmishing exosuit." // [CELADON-EDIT]
	source_mech = list(/obj/mecha/combat/gygax,/obj/mecha/combat/gygax/dark)
