...
/obj/item/mecha_parts/mecha_equipment/weapon/ballistic/railgun
	...
	desc = "A plasma railgun manufactured by Nanotrasen and taking a different direction from their handheld counterpart. Namely utilizing the plasma Nanotrasen had such large quantities of to help with heating and accelerating the projectile. Shoots super-heated high-density iron-tungsten rods at ludicrous speeds." // [CELADON-EDIT]
