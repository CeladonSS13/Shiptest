...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_SOLFED = FREQ_SOLFED, RADIO_CHANNEL_SOLFED_LONG = FREQ_SOLFED_LONG,
	RADIO_CHANNEL_SYNDICATE = FREQ_SYNDICATE, RADIO_CHANNEL_SYNDICATE_LONG = FREQ_SYNDICATE_LONG,
	RADIO_CHANNEL_NANOTRASEN = FREQ_NANOTRASEN, RADIO_CHANNEL_NANOTRASEN_LONG = FREQ_NANOTRASEN_LONG,
	RADIO_CHANNEL_ELYSIUM = FREQ_ELYSIUM, RADIO_CHANNEL_ELYSIUM_LONG = FREQ_ELYSIUM_LONG,
	RADIO_CHANNEL_INTEQ = FREQ_INTEQ, RADIO_CHANNEL_INTEQ_LONG = FREQ_INTEQ_LONG,
	RADIO_CHANNEL_SUNS = FREQ_SUNS, RADIO_CHANNEL_SUNS_LONG = FREQ_SUNS_LONG,

	RADIO_CHANNEL_RAMZI = FREQ_RAMZI,
	RADIO_CHANNEL_SUNS = FREQ_SUNS,
	RADIO_CHANNEL_WARRA = FREQ_WARRA,
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_SOLFED]" = RADIO_CHANNEL_SOLFED, "[FREQ_SOLFED_LONG]" = RADIO_CHANNEL_SOLFED_LONG,
	"[FREQ_SYNDICATE]" = RADIO_CHANNEL_SYNDICATE, "[FREQ_SYNDICATE_LONG]" = RADIO_CHANNEL_SYNDICATE_LONG,
	"[FREQ_NANOTRASEN]" = RADIO_CHANNEL_NANOTRASEN, "[FREQ_NANOTRASEN_LONG]" = RADIO_CHANNEL_NANOTRASEN_LONG,
	"[FREQ_ELYSIUM]" = RADIO_CHANNEL_ELYSIUM, "[FREQ_ELYSIUM_LONG]" = RADIO_CHANNEL_ELYSIUM_LONG,
	"[FREQ_INTEQ]" = RADIO_CHANNEL_INTEQ, "[FREQ_INTEQ_LONG]" = RADIO_CHANNEL_INTEQ_LONG,
	"[FREQ_SUNS]" = RADIO_CHANNEL_SUNS, "[FREQ_SUNS_LONG]" = RADIO_CHANNEL_SUNS_LONG,

	"[FREQ_RAMZI]" = RADIO_CHANNEL_RAMZI,
	"[FREQ_WARRA]" = RADIO_CHANNEL_WARRA,
	"[FREQ_MINUTEMEN]" = RADIO_CHANNEL_MINUTEMEN,
	"[FREQ_PGF]" = RADIO_CHANNEL_PGF,
	"[FREQ_PIRATE]" = RADIO_CHANNEL_PIRATE,
	"[FREQ_VOX]" = RADIO_CHANNEL_VOX,
))
// [/CELADON-EDIT]
