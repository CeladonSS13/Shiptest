...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_SOLFED = FREQ_SOLFED,
	...
	RADIO_CHANNEL_ELYSIUM = FREQ_ELYSIUM,
	RADIO_CHANNEL_INTEQ = FREQ_INTEQ,
	RADIO_CHANNEL_PIRATE = FREQ_PIRATE,
	RADIO_CHANNEL_SUNS = FREQ_SUNS,
	RADIO_CHANNEL_SOLFED_SHORT = FREQ_SOLFED_SHORT,
	RADIO_CHANNEL_SYNDICATE_SHORT = FREQ_SYNDICATE_SHORT,
	RADIO_CHANNEL_NANOTRASEN_SHORT = FREQ_NANOTRASEN_SHORT,
	RADIO_CHANNEL_ELYSIUM_SHORT = FREQ_ELYSIUM_SHORT,
	RADIO_CHANNEL_INTEQ_SHORT = FREQ_INTEQ_SHORT,
	RADIO_CHANNEL_SUNS_SHORT = FREQ_SUNS_SHORT,
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_SOLFED]" = RADIO_CHANNEL_SOLFED,
	...
	"[FREQ_SUNS]" = RADIO_CHANNEL_SUNS,
	"[FREQ_NANOTRASEN]" = RADIO_CHANNEL_NANOTRASEN,
	"[FREQ_RAMZI]" = RADIO_CHANNEL_RAMZI,
	"[FREQ_ELYSIUM]" = RADIO_CHANNEL_ELYSIUM,
	"[FREQ_INTEQ]" = RADIO_CHANNEL_INTEQ,
	"[FREQ_PIRATE]" = RADIO_CHANNEL_PIRATE,
	"[FREQ_VOX]" = RADIO_CHANNEL_VOX,
	"[FREQ_SUNS]" = RADIO_CHANNEL_SUNS,
	"[FREQ_SOLFED_SHORT]" = RADIO_CHANNEL_SOLFED_SHORT,
	"[FREQ_SYNDICATE_SHORT]" = RADIO_CHANNEL_SYNDICATE_SHORT,
	"[FREQ_NANOTRASEN_SHORT]" = RADIO_CHANNEL_NANOTRASEN_SHORT,
	"[FREQ_ELYSIUM_SHORT]" = RADIO_CHANNEL_ELYSIUM_SHORT,
	"[FREQ_INTEQ_SHORT]" = RADIO_CHANNEL_INTEQ_SHORT,
	"[FREQ_SUNS_SHORT]" = RADIO_CHANNEL_SUNS_SHORT,
))
// [/CELADON-EDIT]
