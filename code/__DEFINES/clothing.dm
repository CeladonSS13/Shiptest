...
#define EQUIP_DELAY_OVERSUIT (2 SECONDS) // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем КД на вещи

/// Delay base for suit slot items
#define EQUIP_DELAY_SUIT (1 SECONDS) // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем КД на вещи

/// Delay base for hard-body shoes and boots.
#define EQUIP_DELAY_BOOTS (0 SECONDS) // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем КД на вещи
/// Delay base for hard-body, strapped, or otherwise head-covering hats.
#define EQUIP_DELAY_HELMET (0.5 SECONDS) // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем КД на вещи
/// Delay base for shoes.
#define EQUIP_DELAY_SHOES (0 SECONDS) // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем КД на вещи
/// Delay base for suit and cloak slot items that are trivially removed or put on. (Coats, Jackets, Ponchos, etc.)
#define EQUIP_DELAY_COAT (0 SECONDS) // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем КД на вещи
/// Delay base for Undersuits.
#define EQUIP_DELAY_UNDERSUIT (1 SECONDS) // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем КД на вещи

/// Delay base for masks.
#define EQUIP_DELAY_MASK (0.5 SECONDS) // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем КД на вещи
/// Delay base for back-worn objects.
#define EQUIP_DELAY_BACK (1 SECONDS) // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем КД на вещи
/// Delay base for belts.
#define EQUIP_DELAY_BELT (0 SECONDS) // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем КД на вещи
/// Delay base for hats.
#define EQUIP_DELAY_HAT (0 SECONDS) // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем КД на вещи
/// Delay base for gloves.
#define EQUIP_DELAY_GLOVES (0 SECONDS) // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем КД на вещи
/// Delay base for glasses.
#define EQUIP_DELAY_EYEWEAR (0 SECONDS) // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем КД на вещи
