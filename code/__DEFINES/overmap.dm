...
// #define DYNAMIC_WORLD_LIST_ALL list(\ // CELADON-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_LAVA,\ // CELADON-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_ICE,\ // CELADON-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_SAND,\ // CELADON-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_JUNGLE,\ // CELADON-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_ROCKPLANET,\ // CELADON-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_BEACHPLANET,\ // CELADON-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_WASTEPLANET,\ // CELADON-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_REEBE,\ // CELADON-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_ASTEROID,\ // CELADON-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_SPACERUIN,\ // CELADON-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_GAS_GIANT,\ // CELADON-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_PLASMA_GIANT) // CELADON-EDIT -> ORIGINAL
