...
#define RIOL_MASK_PATH 'mod_celadon/_storge_icons/icons/items/clothing/onmob_mask_riol.dmi'
#define RIOL_HEAD_PATH 'mod_celadon/_storge_icons/icons/items/clothing/onmob_head_riol.dmi'
#define RIOL_SUIT_PATH 'mod_celadon/_storge_icons/icons/items/clothing/onmob_suit_riol.dmi'
