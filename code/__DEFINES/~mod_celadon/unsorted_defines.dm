...
/datum/map_template/shuttle
	var/token_icon_state = "ship" // [CELADON-EDIT] - CELADON_OVERMAP_ICON - спрайты некросивые получаюца
...
/obj/item/storage/toolbox/infiltrator/ComponentInitialize()
	...
	storage_component.can_hold_description = generate_hold_desc(storage_component.can_hold)
...
/turf/closed/mineral/random/Initialize(mapload, inherited_virtual_z)
	if(/turf/closed/mineral/random::mineralSpawnChanceList == type::mineralSpawnChanceList)
