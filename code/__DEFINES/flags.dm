...
#define ZAP_MAJOR_STORM_FLAGS ZAP_STORM_FLAGS | ZAP_GIVES_RESEARCH	// [CELADON-EDIT]- DANGER_STORM
#define ZAP_MINOR_STORM_FLAGS ZAP_OBJ_DAMAGE | ZAP_MOB_DAMAGE		// [CELADON-EDIT]- DANGER_STORM
