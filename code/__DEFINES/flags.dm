...
// [CELADON-EDIT]
//#define ZAP_STORM_FLAGS ZAP_OBJ_DAMAGE | ZAP_MOB_DAMAGE | ZAP_MOB_STUN // [CELADON-EDIT] - ORIGINAL
#define ZAP_STORM_FLAGS ZAP_OBJ_DAMAGE | ZAP_MOB_DAMAGE | ZAP_MOB_STUN | ZAP_ALLOW_DUPLICATES
// [/CELADON-EDIT]
