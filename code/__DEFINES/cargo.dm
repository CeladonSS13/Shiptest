...
GLOBAL_LIST_INIT(podstyles, list(\
	...
	list(POD_SHAPE_NORML, "darkpod",	TRUE,	"deathsquad",	"blue",		RUBBLE_NORMAL,	"\improper Deathsquad drop pod",	"A mysterious drop pod. This one has been marked with markings from... the Death Squad comic book?"),\
	list(POD_SHAPE_NORML, "pod",		TRUE,	"cultist",		"red",		RUBBLE_NORMAL,	"bloody supply pod",	"A Makosso-Warra supply pod covered in scratch-marks, blood, and strange runes."),\
