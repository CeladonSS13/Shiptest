...
#define MAX_WEIGHT_CLASS_BACKPACK WEIGHT_CLASS_NORMAL // [CELADON-EDIT] - CELADON_BALANCE_CD - Меняем размер на нормал
...
// [CELADON-EDIT]
#define STORAGE_VOLUME_SATCHEL (DEFAULT_VOLUME_NORMAL * 7) // 7 normal items
#define STORAGE_VOLUME_BACKPACK (DEFAULT_VOLUME_NORMAL * 7) // 7 normal items
// [/CELADON-EDIT]
