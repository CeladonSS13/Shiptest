...
/obj/item/codespeak_manual/attack_self(mob/living/user)
	...
	user.grant_language(/datum/language/codespeak, source = LANGUAGE_MIND) // [CELADON-EDIT] - FIX_LANGUAGE_MIND
...
/obj/item/codespeak_manual/attack(mob/living/M, mob/living/user)
	...
	if(M.stat == DEAD)
		...
		M.grant_language(/datum/language/codespeak, source = LANGUAGE_MIND) // [CELADON-EDIT] - FIX_LANGUAGE_MIND
		use_charge(user)
