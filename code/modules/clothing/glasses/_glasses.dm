...
/obj/item/clothing/glasses/blindfold/white/worn_overlays(isinhands = FALSE, file2use)
	...
	if(!isinhands && ishuman(loc) && !colored_before)
		...
		var/mutable_appearance/M = mutable_appearance('mod_celadon/_storage_icons/icons/items/clothing/eyes/overlay/eyes.dmi', "blindfoldwhite") // [CELADON-EDIT] - CELADON_RETURN_CONTENT_SPAWN
