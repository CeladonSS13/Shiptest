...
/client/verb/verify_in_discord()
	...
	if(cached_one_time_token && cached_one_time_token != "")
		...
		message = "Вы уже сгенерировали свой одноразовый токен. Если вам нужен новый токен, то вам придётся подождать до конца раунда или переключиться на другой сервер.\nВы можете верифицировать себя в Discord, используя команду:\n/verify [cached_one_time_token]\n\nCeladon Discord: https://discord.com/invite/rxsggTJzY3"
		// [/CELADON-EDIT]
		...
		message = "Вы можете верифицировать себя в Discord, используя команду:\n/verify [one_time_token]\n\nCeladon Discord: https://discord.com/invite/rxsggTJzY3"
		// [/CELADON-EDIT]
