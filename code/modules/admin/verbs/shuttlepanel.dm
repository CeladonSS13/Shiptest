...
/obj/docking_port/mobile/proc/admin_fly_shuttle(mob/user)
	...
	switch(selection)
		if("Infinite Transit")
			...
			log_celadon_admin("\[SHUTTLE]: [key_name_admin(user)] has placed [name] into Infinite Transit.") // [CELADON_ADD] - logging admin actions.
		...
		if("Delete Shuttle")
			...
			log_celadon_admin("\[SHUTTLE]: [key_name_admin(user)] has deleted [name].") // [CELADON_ADD] - logging admin actions.
