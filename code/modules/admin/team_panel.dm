...
/datum/team/custom/proc/admin_force_hud(mob/user)
	// [CELADON-EDIT] - OLD_CODE: var/list/possible_icons = icon_states('icons/mob/hud.dmi')
	var/list/possible_icons = icon_states('mod_celadon/_storge_icons/icons/mobs/hud.dmi')
	// [/CELADON-EDIT]
