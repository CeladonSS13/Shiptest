...
/datum/admins/proc/show_player_panel(mob/M in GLOB.mob_list)
	...
	body += "<A href='byond://?_src_=holder;[HrefToken()];showmessageckey=[M.ckey]'>Notes / Watchlist</A>"
	if(M.client)
		...
		body += "<br><b>Mute: </b> "
		body += "<A href='byond://?_src_=holder;[HrefToken()];mute=[M.ckey];mute_type=[MUTE_IC]'><font color='[(muted & MUTE_OOC)?"red":"blue"]'>IC</font></a>"
		...
		body += "<A href='byond://?_src_=holder;[HrefToken()];mute=[M.ckey];mute_type=[MUTE_MENTORHELP]'><font color='[(muted & MUTE_MENTORHELP)?"red":"blue"]'>MENTORHELP</font></a>"
...
/datum/admins/proc/access_news_network() //MARKER
	...
	switch(admincaster_screen)
		if(0)
			...
			dat+="<BR><A href='byond://?src=[REF(src)];[HrefToken()];ac_menu_censor_channel=1'>Mark Feed Channel with Makosso-Warra D-Notice (disables and locks the channel).</A>"
		...
		if(9)
			...
			if(src.admincaster_feed_channel.censored)
				dat+="<FONT COLOR='red'><B>ATTENTION: </B></FONT>This channel has been deemed as threatening to the welfare of the station, and marked with a Makosso-Warra D-Notice.<BR>"
...
/datum/admins/proc/show_lag_switch_panel()
	...
	dat += "Disable planet deletion: <a href='byond://?_src_=holder;[HrefToken()];change_lag_switch=[DISABLE_PLANETDEL]'><b>[SSlag_switch.measures[DISABLE_PLANETDEL] ? "On" : "Off"]</b></a><br/>"
	dat += "Disable <b>ALL</b> planet GENERATION: <a href='byond://?_src_=holder;[HrefToken()];change_lag_switch=[DISABLE_PLANETGEN]'><b>[SSlag_switch.measures[DISABLE_PLANETGEN] ? "On" : "Off"]</b></a><br/>"
