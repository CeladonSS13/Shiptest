...
/obj/item/pickaxe/drill/diamonddrill
	...
	toolspeed = 0.2
	desc = "EXOCOM's improvement on the Nanotrasen autodrill design, featuring a premium diamond cutting head. Yours is the drill that will pierce the heavens!" // [CELADON-EDIT]
	force = 20
	custom_materials = list(/datum/material/diamond=2000)
...
/obj/item/pickaxe/drill/jackhammer
	...
	desc = "The epitome of conventional rock-smashing technology, invented by Nanotrasen and cost-optimized by EXOCOM. Smashes rocks, objects, and unfortunate wildlife with sonic blasts." // [CELADON-EDIT]
	force = 20
