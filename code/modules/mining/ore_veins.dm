...
/obj/structure/vein/shrouded/classtwo
	...
	vein_class = 2
	mob_types = list(
		/mob/living/simple_animal/hostile/asteroid/royalcrab = 10, // [CELADON-EDIT] - CELADON_BALANCE // /mob/living/simple_animal/hostile/asteroid/royalcrab = 30,
		/mob/living/simple_animal/hostile/alien = 5,
		/mob/living/simple_animal/hostile/alien/drone = 5,
		/mob/living/simple_animal/hostile/alien/sentinel = 1,
		)
...
/obj/structure/vein/shrouded/classthree
	...
	mob_types = list(
		/mob/living/simple_animal/hostile/asteroid/royalcrab = 5, 	// [CELADON-EDIT] - CELADON_BALANCE - // /mob/living/simple_animal/hostile/asteroid/royalcrab = 10,
		/mob/living/simple_animal/hostile/alien = 5,
		/mob/living/simple_animal/hostile/alien/drone = 5,
		/mob/living/simple_animal/hostile/alien/sentinel = 2, // [CELADON-EDIT] - CELADON_BALANCE // /mob/living/simple_animal/hostile/alien/sentinel = 1,
		/mob/living/simple_animal/hostile/alien/praetorian = 1, // [CELADON-ADD] - CELADON_BALANCE
		)
