...
/datum/preferences/proc/load_character(slot)
	...
	if(species_id == "tajaran")
		hairstyle								= sanitize_inlist(hairstyle, GLOB.tajaran_hairs_list)
		facial_hairstyle						= sanitize_inlist(facial_hairstyle, GLOB.tajaran_facial_hairs_list)
	...
	features["tajaran_ears_markings_color"]				= sanitize_hexcolor(features["tajaran_ears_markings_color"])
	features["tajaran_head_markings_color"]				= sanitize_hexcolor(features["tajaran_head_markings_color"])
	features["tajaran_nose_markings_color"]				= sanitize_hexcolor(features["tajaran_nose_markings_color"])
	features["tajaran_chest_markings_color"]				= sanitize_hexcolor(features["tajaran_chest_markings_color"])
	features["tajaran_body_markings_color"]				= sanitize_hexcolor(features["tajaran_body_markings_color"])
	// [CELADON-ADD] - CELADON_RIOL
...
/datum/preferences/proc/save_character()
	...
	WRITE_FILE(S["tajaran_ears_markings_color"], features["tajaran_ears_markings_color"])
	WRITE_FILE(S["tajaran_head_markings_color"], features["tajaran_head_markings_color"])
	WRITE_FILE(S["tajaran_nose_markings_color"], features["tajaran_nose_markings_color"])
	WRITE_FILE(S["tajaran_chest_markings_color"], features["tajaran_chest_markings_color"])
	WRITE_FILE(S["tajaran_body_markings_color"], features["tajaran_body_markings_color"])
	// [CELADON-ADD] - CELADON_RIOL
