...
/datum/supply_order/proc/generateManifest(obj/structure/closet/crate/container, owner, ordering_ship_name)
	var/manifest_text = "<h2><font face = 'Adobe Pi Std'>[command_name()] Shipping Manifest</h2>"	//var/manifest_text = "<h2><font face = 'Adobe Pi Std'>[market.name] Shipping Manifest</h2>"" // [CELADON-EDIT] - ORIGINAL
	manifest_text += "<hr/>"
