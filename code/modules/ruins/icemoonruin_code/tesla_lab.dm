/obj/item/tape/random/preset/tesla_lab/one/Initialize()
	...
	storedinfo = list(
		...
		"\[00:02\] [span_name("scared human woman")] whispers \"My n-name is Alyssa Salata- Ident 4070591. SolGov Solider-\"",
...
/obj/item/tape/random/preset/tesla_lab/two/Initialize()
	...
	storedinfo = list(
		"\[00:00\] Recording started.",
		"\[00:03\] [span_name("scared human woman")] whispers \"My n-name is Alyssa Salata- Ident 4070591. SolGov Solider-\"",
...
/obj/effect/mob_spawn/human/corpse/clip/minuteman/forcefem
	name = "CLIP Minuteman Spawner"
	// MOD Celadon: Изменение аутфита CLIP на SolGov
