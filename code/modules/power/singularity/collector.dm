...
#define RAD_COLLECTOR_STORED_OUT 0.001	// (this*100)% of stored power outputted per tick. Doesn't actualy change output total, lower numbers just means collectors output for longer in absence of a source // [CELADON-EDIT] - CELADON_BALANCE - Трогаем рад коллекторы
