...
/datum/design/leftarm
	...
	// 	category = list("initial",SPECIES_HUMAN,SPECIES_SARATHI,SPECIES_MOTH,SPECIES_PLASMAMAN,SPECIES_ELZUOSE,SPECIES_RACHNID,SPECIES_VOX,SPECIES_KEPORI,SPECIES_ABDUCTOR,SPECIES_FLYPERSON,,SPECIES_SKELETON,SPECIES_SNAIL)
	category = list("initial",SPECIES_HUMAN,SPECIES_SARATHI,SPECIES_MOTH,SPECIES_PLASMAMAN,SPECIES_ELZUOSE,SPECIES_RACHNID,SPECIES_VOX,SPECIES_KEPORI,SPECIES_ABDUCTOR,SPECIES_FLYPERSON,SPECIES_SKELETON,SPECIES_SNAIL,SPECIES_TAJARA,SPECIES_RIOL)
	// [/CELADON-EDIT]
...
/datum/design/rightleg
	...
	// [CELADON-EDIT] - TAJARA, CELADON_RIOL
	// category = list("initial",SPECIES_HUMAN,SPECIES_SARATHI,SPECIES_MOTH,SPECIES_PLASMAMAN,SPECIES_ELZUOSE,SPECIES_RACHNID,SPECIES_VOX,SPECIES_KEPORI,SPECIES_ABDUCTOR,SPECIES_FLYPERSON,SPECIES_SKELETON,SPECIES_SNAIL) // CELADON-EDIT - ORIGINAL
	category = list("initial",SPECIES_HUMAN,SPECIES_SARATHI,SPECIES_MOTH,SPECIES_PLASMAMAN,SPECIES_ELZUOSE,SPECIES_RACHNID,SPECIES_VOX,SPECIES_KEPORI,SPECIES_ABDUCTOR,SPECIES_FLYPERSON,SPECIES_SKELETON,SPECIES_SNAIL,SPECIES_TAJARA,SPECIES_RIOL)
	// [/CELADON-EDIT]
