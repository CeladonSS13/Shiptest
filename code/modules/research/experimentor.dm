...
/obj/machinery/rnd/experimentor
	...
	icon = 'mod_celadon/_storage_icons/icons/machinery/heavy_lathe.dmi' // [CELADON-EDIT] - Original - 'icons/obj/machines/heavy_lathe.dmi'
	icon_state = "h_lathe"
...
/obj/item/relic/proc/petSpray(mob/user)
	...
	var/counter
	var/list/valid_animals = list(/mob/living/simple_animal/parrot, /mob/living/simple_animal/butterfly, /mob/living/simple_animal/pet/cat, /mob/living/simple_animal/pet/dog/corgi, /mob/living/simple_animal/crab, /mob/living/simple_animal/pet/fox, /mob/living/simple_animal/hostile/lizard, /mob/living/basic/mouse, /mob/living/simple_animal/pet/dog/pug, /mob/living/basic/bear, /mob/living/simple_animal/hostile/poison/bees, /mob/living/simple_animal/hostile/carp)
