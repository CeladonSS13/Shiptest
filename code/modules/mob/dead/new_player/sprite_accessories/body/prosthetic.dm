...
/datum/sprite_accessory/body/prosthetic/tajara
	...
	replacement_bodyparts = list(
		BODY_ZONE_CHEST = /obj/item/bodypart/chest/robot/tajara,
		BODY_ZONE_HEAD = /obj/item/bodypart/head/robot/tajara,
		BODY_ZONE_L_ARM = /obj/item/bodypart/l_arm/robot/surplus/tajara,
		BODY_ZONE_R_ARM = /obj/item/bodypart/r_arm/robot/surplus/tajara,
		BODY_ZONE_L_LEG = /obj/item/bodypart/leg/left/robot/surplus/tajara,
		BODY_ZONE_R_LEG = /obj/item/bodypart/leg/right/robot/surplus/tajara
	)
	allowed_species = list(/datum/species/tajara)
	bodytype = BODYTYPE_TAJARA

/datum/sprite_accessory/body/prosthetic/riol
	name = "Prosthetic Riol"
	replacement_bodyparts = list(
		BODY_ZONE_CHEST = /obj/item/bodypart/chest/robot/riol,
		BODY_ZONE_HEAD = /obj/item/bodypart/head/robot/riol,
		BODY_ZONE_L_ARM = /obj/item/bodypart/l_arm/robot/surplus/riol,
		BODY_ZONE_R_ARM = /obj/item/bodypart/r_arm/robot/surplus/riol,
		BODY_ZONE_L_LEG = /obj/item/bodypart/leg/left/robot/surplus/riol,
		BODY_ZONE_R_LEG = /obj/item/bodypart/leg/right/robot/surplus/riol
	)
	allowed_species = list(/datum/species/riol)
	bodytype = BODYTYPE_LANIUS


/datum/sprite_accessory/body/prosthetic/lanius
	name = "Prosthetic Lanius"
	replacement_bodyparts = list(
