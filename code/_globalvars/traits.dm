...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		// [CELADON-ADD] - CELADON_RETURN_CONTENT_QUIRKS, CELADON_ACHIEVEMENTS, CELADON_RETURN_CONTENT_CLOWNS
		...
		"TRAIT_ELITE_CHALLENGER" = TRAIT_ELITE_CHALLENGER, // Given to elite tumor fighters
