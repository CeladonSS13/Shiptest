...
DEFINE_BITFIELD(area_flags, list(
	...
	"SHIP_SMOOTHING" = SHIP_SMOOTHING,
	"NO_RANDOM_LIGHT_BREAKAGE" = NO_RANDOM_LIGHT_BREAKAGE,
))
...
DEFINE_BITFIELD(interaction_flags_machine, list(
	...
	"INTERACT_MACHINE_UNPOWERED" = INTERACT_MACHINE_UNPOWERED,
	"INTERACT_MACHINE_BROKEN" = INTERACT_MACHINE_BROKEN,
...
DEFINE_BITFIELD(item_flags, list(
	...
	"NO_ROTATE_RANDOM_THROW" = NO_ROTATE_RANDOM_THROW,	// [CELADON-ADD]
))
...
DEFINE_BITFIELD(power_flags, list(
	"POWER_ALLOW_AREA" = POWER_ALLOW_AREA,
	"POWER_ALLOW_WIRE" = POWER_ALLOW_WIRE,
))
