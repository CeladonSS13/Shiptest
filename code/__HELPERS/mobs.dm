...
/proc/random_features()
	...
	if(!GLOB.tajaran_animated_tail_list.len)
		init_sprite_accessory_subtypes(/datum/sprite_accessory/tails_animated/tajaran, GLOB.tajaran_animated_tail_list)
	...
	return list(
		...
		// [/CELADON-EDIT]
		// [CELADON-ADD] - SPECIES_TAJARAN
		"tajaran_ears_markings_color" = pick("FFFFFF","7F7F7F", "7BBB7B", "7B7BBB", "BB7B7B", "7BBBBB", "BB7BBB", "BBBB7B"),
		"tajaran_head_markings_color" = pick("FFFFFF","7F7F7F", "7BBB7B", "7B7BBB", "BB7B7B", "7BBBBB", "BB7BBB", "BBBB7B"),
		"tajaran_nose_markings_color" = pick("FFFFFF","7F7F7F", "7BBB7B", "7B7BBB", "BB7B7B", "7BBBBB", "BB7BBB", "BBBB7B"),
		"tajaran_chest_markings_color" = pick("FFFFFF","7F7F7F", "7BBB7B", "7B7BBB", "BB7B7B", "7BBBBB", "BB7BBB", "BBBB7B"),
		"tajaran_body_markings_color" = pick("FFFFFF","7F7F7F", "7BBB7B", "7B7BBB", "BB7B7B", "7BBBBB", "BB7BBB", "BBBB7B"),
		// [CELADON-ADD] - CELADON_RIOL
