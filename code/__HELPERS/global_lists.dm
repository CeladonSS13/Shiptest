...
/proc/make_datum_references_lists()
	...
	init_sprite_accessory_subtypes(/datum/sprite_accessory/tails/tajaran, GLOB.tajara_tail_list)
	init_sprite_accessory_subtypes(/datum/sprite_accessory/tails_animated/tajaran, GLOB.tajara_animated_tail_list)
