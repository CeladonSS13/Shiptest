...
(Подсказка: чтобы вставить в git bash можно нажать ПКМ по окну, или использовать <kbd>Shift</kbd>+<kbd>Insert</kbd>)
...
Первая установка должна быть довольно простой. Во-первых, тебе надо установить BYOND. Его можно скачать [здесь](http://www.byond.com/), а нужную версию узнать можно [здесь](https://github.com/CeladonSS13/Shiptest/blob/beta-dev/docs/SECURITY.md).
