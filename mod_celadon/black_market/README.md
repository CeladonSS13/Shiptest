...
Этот мод служит домом для товаров с черного рынка. А также меняем тут ценники и прочее.
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/black_market.dm`: `BLACK_MARKET_SPEED_MULTIPLIER`, `BLACK_MARKET_SPEED_BASE`
-->
