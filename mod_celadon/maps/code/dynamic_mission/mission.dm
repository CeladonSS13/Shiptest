...
/datum/mission/ruin/dead_vanguard
	...
	desc = "Inteq потеряла связь с заказчиком и авангардистом, который выполнял его задание. На данный момент силы ЧВК находятся на заданиях более приоритетных, чем возвращение тела одного из сотрудников, а потому Inteq готова выдать это поручение любому, кто гораст вернуть тело авангардиста. Его имя - Кавур."
