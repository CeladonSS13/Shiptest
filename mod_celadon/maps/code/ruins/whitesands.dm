...
// combined extra large ruin of several other whitesands survivor ruins
/datum/map_template/ruin/whitesands/survivors/combination
	id = "ws-combination"
...
/datum/map_template/ruin/whitesands/trainyard
	id = "train-yard"
	name = "Train Yard"
