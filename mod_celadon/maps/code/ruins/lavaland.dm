...
/datum/map_template/ruin/lavaland/ashwalker_shrine
	...
	description = "A shrine to the ashwalker gods, built by the ashwalkers themselves."
...
/datum/map_template/ruin/lavaland/bubble_outpost
	...
	suffix = "lavaland_surface_bubble_outpost.dmm"
...
/datum/map_template/ruin/lavaland/dwarffortress
	id = "dwarffortress"
	name = "Dwarf Fortress"
	description = "A sturdy fortification built by the dwarves, now abandoned and overrun with lava creatures."
