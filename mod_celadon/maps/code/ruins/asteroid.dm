...
/datum/map_template/ruin/asteroid/abandoned_remora
	...
	suffix = "asteroid_abandoned_remora.dmm"
...
/datum/map_template/ruin/asteroid/corporate_mining
	...
	suffix = "asteroid_corporate_mining.dmm"
...
/datum/map_template/ruin/asteroid/dangerous_research
	id = "dangerous_research"
	name = "Dangerous Research Facility"
	description = "An abandoned research facility with dangerous experiments."
	suffix = "asteroid_dangerous_research.dmm"

/datum/map_template/ruin/asteroid/glade
	id = "dark_glade"
	name = "Dark Glade"
	description = "It's always dark in the ancient glade."
	suffix = "asteroid_dark_glade.dmm"

/datum/map_template/ruin/asteroid/excavator_DK
	id = "Excavator-DK"
	name = "Excavator DK Class"
	description = "A heavily damaged DK class excavator"
	suffix = "asteroid_excavator_DK.dmm"

/datum/map_template/ruin/asteroid/gondolaasteroid
	id = "gondolaasteroid"
	name = "Gondola Asteroid"
	description = "A gondola ship crashed into an asteroid"
	suffix = "asteroid_gondolaasteroid.dmm"

/datum/map_template/ruin/asteroid/lima_facility
	id = "lima_facility"
	name = "Lima Facility"
	description = "The secret facility from which the S.O.S. signal was sent."
	suffix = "asteroid_lima_facility.dmm"
...
/datum/map_template/ruin/asteroid/onehalf
	...
	suffix = "asteroid_onehalf.dmm"
	ruin_tags = list(RUIN_TAG_MINOR_COMBAT, RUIN_TAG_MEDIUM_LOOT, RUIN_TAG_INHOSPITABLE)

/datum/map_template/ruin/asteroid/oretruck
	id = "oretruck"
	name = "Ore Truck"
	description = "A crashed ore truck with potential loot."
	suffix = "asteroid_oretruck.dmm"
...
/datum/map_template/ruin/asteroid/power_puzzle
	...
	suffix = "asteroid_power_puzzle.dmm"
...
/datum/map_template/ruin/asteroid/singularitylab
	...
	suffix = "asteroid_singularity_lab.dmm"
	ruin_tags = list(RUIN_TAG_BOSS_COMBAT, RUIN_TAG_MAJOR_LOOT, RUIN_TAG_SHELTER)

/datum/map_template/ruin/asteroid/transport18
	id = "transport18"
	name = "Transport 18"
	description = "A crashed transport ship with potential loot."
	suffix = "asteroid_transport18.dmm"
