/datum/modpack/fixes
	name = "Fixes"
	desc = "Содержит различные фиксы багов. Фикс удушья при пустом баллоне. Сломанные иконки. Исправление работы плазма двигателей,фикс зарядки револьверов" // TODO сделать ПР для офов
