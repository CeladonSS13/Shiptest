/obj/item/tank/jetpack/suit
	...
	icon = 'mod_celadon/_storge_icons/icons/items/obj1/jetpack_suit/items.dmi' //Changed item icon
...
/obj/item/tank/jetpack/suit/turn_on(mob/user)
	...
	icon = 'mod_celadon/_storge_icons/icons/items/obj1/jetpack_suit/tank.dmi'
