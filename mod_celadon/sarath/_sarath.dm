...
/datum/modpack/sarath
	name = "Sarathi"
	desc = "Содержит механики и изменения направленные на Саратхов. Включает: регенерация саратхов"
	author = "MrCat15352"
...
// Инициализация ДО
/datum/modpack/sarath/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/sarath/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/sarath/post_initialize()
	. = ..()
