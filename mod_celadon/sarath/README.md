...
Этот мод будет служить местом хранения механик и прочего связаного с саратхами
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/sarath.dm`: `SARATH_SPEED_MULTIPLIER`, `SARATH_SPEED_BASE`
-->
