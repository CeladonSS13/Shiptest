/obj/item/bong
	...
	icon = 'mod_celadon/_storge_icons/icons/items/bongs/bong.dmi'
	lefthand_file = 'mod_celadon/_storge_icons/icons/items/bongs/bong.dmi'
	righthand_file = 'mod_celadon/_storge_icons/icons/items/bongs/bong.dmi'
	icon_state = "bongoff"
