...
/obj/item/mod/module/blood_replika
	...
	use_mod_colors = TRUE
	var/active_time = 45 SECONDS

/obj/item/mod/module/blood_replika/on_activation()
	. = ..()
	if(!.)
		return
...
/obj/item/mod/module/blood_replika/on_deactivation(display_message = TRUE, deleting = FALSE)
	. = ..()
	if(!.)
		return
	if(!deleting)
