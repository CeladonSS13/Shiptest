...
/datum/outfit/outpost/bartender/post_equip(mob/living/carbon/human/H, visualsOnly)
	...
	if(H.age < AGE_MINOR)
		...
		to_chat(H, span_notice("Формально вы еще не достигли совершеннолетия, чтобы иметь доступ к алкоголю или подавать его, но ваше удостоверение личности незаметно изменено, чтобы показать ваш возраст как [AGE_MINOR]. Постарайтесь сохранить это в тайне!"))
