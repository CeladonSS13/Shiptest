...
/obj/effect/mob_spawn/human/elysium_outpost/cook
	...
	important_info = "Не покидайте свой аванпост без разрешения администрации, кроме тех случаев, когда вас силой забрали! Вы устроились сюда работать по тем или иным причинам, вы должны выполнять свои рабочие обязанности и сохранить своё рабочее место. Помните, вы гражданин элизиума и хоть вы можете выражать симпатии тем или иным фракциям, вы остаетесь верными законной власти. В случае нападения на вас, вы можете прибегнуть к необходимой самообороне, однако помните, вы не военный, вы мирный житель, ваша цель жить и выполнять свои обязанности, за которые вам платит государство!"
	short_desc = "Готовьте еду, выращивайте растения, держите в чистоте свою кухню, разговаривайте с посетителями, поднимайте настроение им своей стряпнёй."
...
/obj/effect/mob_spawn/human/elysium_outpost/artist
	...
	important_info = "Не покидайте свой аванпост без разрешения администрации, кроме тех случаев, когда вас силой забрали! Вы устроились сюда работать по тем или иным причинам, вы должны выполнять свои рабочие обязанности и сохранить своё рабочее место. Помните вы гражданин элизиума и хоть вы можете выражать симпатии тем или иным фракциям, вы остаетесь верными законной власти. В случае нападения на вас, вы можете прибегнуть к необходимой самообороне, однако помните вы не военный, вы мирный житель, ваша цель жить и выполнять свои обязанности за которые вам платит государство!"
	short_desc = "Вы известный артист (ну или вы так думаете)! И ваша основная цель это веселить народ вокруг Вас! Устраивайте шоу, рассказывайте анекдоты, делайте на этом деньги!"
...
/obj/effect/mob_spawn/human/elysium_outpost/wagabond/Initialize()
	...
	var/area/A = get_area(src)
	if(A)
		notify_ghosts("Вы просыпаетесь под собачий холод и запах тухлых носков. Ваше сознание смутно припоминает, кем вы были раньше, но вы точно помните, что вас зовут \the [A.name]. Пора прожить ещё один жалкий день в этом аду...", source = src, action=NOTIFY_ATTACK, flashwindow = FALSE)
