	...
	switch(loot)
		...
		if(4)//syndicate incursion. Again, high-quality loot at low chances, this time with excessive levels of danger
			...
			if(prob(35))
				if(prob(15))
					...
					new /mob/living/simple_animal/hostile/human/ramzi/ranged/space/smg(loc)
				else
					if(prob(50))
			...
			if(prob(25))//the real prize
				...
				new /mob/living/simple_animal/hostile/human/ramzi/ranged/space/smg(loc)
				new /mob/living/simple_animal/hostile/human/ramzi/ranged/space/stormtrooper(loc)
			if(prob(35))
				new /obj/item/clothing/shoes/magboots/syndie(loc)
				new /mob/living/simple_animal/hostile/human/ramzi/ranged/space/smg(loc)
			if(prob(25))
				new /obj/item/gun/ballistic/automatic/pistol/ringneck(loc)
				new /obj/item/ammo_box/magazine/
				new /mob/living/simple_animal/hostile/human/ramzi/melee/sledge(loc)
			if(prob(25))
				new /obj/item/ammo_box/magazine/m9mm_rattlesnake(loc)
				new /obj/item/ammo_box/magazine/m9mm_rattlesnake(loc)
				new /mob/living/simple_animal/hostile/human/ramzi/melee/sledge(loc)
			if(prob(35))
			...
			if(prob(35))
				...
				new /mob/living/simple_animal/hostile/human/ramzi/ranged/smg(loc)
			if(prob(25))
				new /mob/living/simple_animal/hostile/human/ramzi/ranged/smg(loc)
				new /mob/living/simple_animal/hostile/human/ramzi/ranged/space/smg(loc)
			if(prob(25))
			...
			if(prob(35))
				...
				new /mob/living/simple_animal/hostile/human/ramzi/ranged/shotgun(loc)
				new /mob/living/simple_animal/hostile/human/ramzi/melee/sledge(loc)
			if(prob(25))
		...
		if(13)//the backroom freezer
			...
			if(prob(25))
				...
				new /mob/living/simple_animal/hostile/killertomato(loc)
			if(prob(35))
				new /obj/item/food/burger/roburgerbig(loc)
				new /mob/living/simple_animal/hostile/killertomato(loc)
			if(prob(35))
		...
		if(14)//legion miniboss
			...
			new /turf/open/indestructible/necropolis(loc)
		if(15)//*you flush the toilet.*
			visible_message(span_userdanger("You hear the faint noise of a long flush and screams about some hole in the roof."))
		...
		if(16)//Research & Zombies
			...
			if(prob(35))
				new /obj/effect/spawner/random/stockparts(loc)
				new /mob/living/simple_animal/hostile/human/zombie(loc)
				new /mob/living/simple_animal/hostile/human/zombie(loc)
			if(prob(15))
				new /obj/effect/spawner/random/stockparts(loc)
			...
			new /mob/living/simple_animal/hostile/human/zombie(loc)
		if(17)//Silverback's locker room
			...
			visible_message(span_alert("Вместо привычного рева, вы слышите плач полный неистовой боли и ненависти. Через всю какофонию звуков удается различить что-то про 'НУЖНО СКАЗАТЬ ЧИТУКЕ'... Что-то пошло по пизде."))
