...
ID мода: CELADON_EVENT_ESCAPE_FROM_SOLFED_PRISON
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/event_escape_from_solfed_prison.dm`: `EVENT_ESCAPE_FROM_SOLFED_PRISON_SPEED_MULTIPLIER`, `EVENT_ESCAPE_FROM_SOLFED_PRISON_SPEED_BASE`
-->
