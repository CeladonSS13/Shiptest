...
- https://github.com/CeladonSS13/Shiptest/pull/2821
<!--
...
- code/__DEFINES/~mod_celadon/atom_hud.dm
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/hoodies.dm`: `HOODIES_SPEED_MULTIPLIER`, `HOODIES_SPEED_BASE`
-->
