...
ID мода: CELADON_SHIP_SHIELD_GENERATOR, CELADON_SHIP_SHIELD
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/ship_shield_generator.dm`: `SHIP_SHIELD_GENERATOR_SPEED_MULTIPLIER`, `SHIP_SHIELD_GENERATOR_SPEED_BASE`
-->
