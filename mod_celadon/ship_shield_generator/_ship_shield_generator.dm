...
/datum/modpack/ship_shield_generator
...
// Инициализация ДО
/datum/modpack/ship_shield_generator/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/ship_shield_generator/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/ship_shield_generator/post_initialize()
	. = ..()
