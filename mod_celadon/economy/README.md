...
Этот мод будет менять экономику. Пока цены поменяем.
...
- EDIT : `mod_celadon/balance/code/engine/rnd.dm`
<!--
...
- `..\code\__DEFINES\~mod_celadon\economy.dm` : Содержит множители цен
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/economy.dm`: `ECONOMY_SPEED_MULTIPLIER`, `ECONOMY_SPEED_BASE`
-->
