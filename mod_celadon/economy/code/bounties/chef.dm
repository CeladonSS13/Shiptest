...
/datum/bounty/item/chef/bread
	...
	reward = 1000
	wanted_types = list(/obj/item/food/bread, /obj/item/food/breadslice, /obj/item/food/bun, /obj/item/food/pizzabread, /obj/item/reagent_containers/food/snacks/rawpastrybase)
