...
Изменения и дополнения контента связанного с боргами и ИИ
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/silicon.dm`: `SILICON_SPEED_MULTIPLIER`, `SILICON_SPEED_BASE`
-->

### Используемые файлы, не содержащиеся в модпаке

- `mod_celadon/_storge_icons/icons/other/borgs/mekaborg.dmi` - Спрайты Мека боргов
<!--
