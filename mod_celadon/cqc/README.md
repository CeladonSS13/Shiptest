...
Убирает граб с CQC лежа что исправляет баг с уменьшением скорости передвижения после grab'а лежа
Вы скажете костыль. 
Гига решение отвечу я
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/cqc.dm`: `CQC_SPEED_MULTIPLIER`, `CQC_SPEED_BASE`
-->
