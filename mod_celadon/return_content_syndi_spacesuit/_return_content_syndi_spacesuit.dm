...
/datum/modpack/return_content_syndi_spacesuit
...
// Инициализация ДО
/datum/modpack/return_syndi_content_spacesuit/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/return_content_syndi_spacesuit/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/return_content_syndi_spacesuit/post_initialize()
	. = ..()
