...
/obj/item/organ/tongue/lanius
	...
	icon = 'mod_celadon/_storge_icons/icons/mobs/species/lanius/lanius_organs.dmi'
	icon_state = "tongue"
	say_mod = "clicks"
	decay_factor = 5
	useable = FALSE
...
/obj/item/bodypart/head/lanius
	icon = 'mod_celadon/_storge_icons/icons/mobs/species/lanius/lanius_bodyparts.dmi'
