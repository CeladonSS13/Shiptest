...
ID мода: CELADON_ADD_MEDICAL_ITEMS
<!--
...
Этот мод добавляет медицинские предметы и возможность их получения, на примере тех предметов что находятся по пути `code\game\objects\items\stacks\medical.dm` и способов их получения по пути `code\modules\reagents\chemistry\recipes\medical_consumables.dm`. 


В будущем этот мод можно использовать для добавления и других медицинских предметов.
<!--
