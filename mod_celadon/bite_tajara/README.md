...
Позволяет таярам кусаться по желанию или от голода.
<!--
...
- `\code\__DEFINES\~mod_celadon\mood.dm`
<!--
...
Pelmenik123 (code)
https://github.com/ss220club/BandaStation/pull/1614 <= Оттуда взяты только спрайты и общая идея
<!--
