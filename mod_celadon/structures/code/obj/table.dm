...
/obj/item/stack/sheet/metal/syndi
	name = "syndi metal"
	icon = 'mod_celadon/_storge_icons/icons/items/obj1/stack_objects.dmi'
	icon_state = "sheet-metal"
	item_state = "sheet-metal"
	lefthand_file = 'mod_celadon/_storge_icons/icons/items/obj1/overlay/sheets_lefthand.dmi'
	righthand_file = 'mod_celadon/_storge_icons/icons/items/obj1/overlay/sheets_righthand.dmi'
