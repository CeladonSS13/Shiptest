...
/obj/item/organ/ears/riol
	name = "riol ears"
	icon = 'mod_celadon/_storge_icons/icons/mobs/species/riol/riol_organs.dmi'	//пока такая хурма, но нужно будет сделать уши отдельно от головы и втыкнуть в какой-либо файл
...
/obj/item/organ/eyes/riol
	name = "Riol eyes"
	icon = 'mod_celadon/_storge_icons/icons/mobs/species/riol/riol_organs.dmi'
	icon_state = "eyes"
	desc = "Some eyes"
...
/obj/item/organ/tail/riol
	...
	icon = 'mod_celadon/_storge_icons/icons/mobs/species/riol/riol_lang.dmi'
	icon_state = "vulptail"
	color = "#661111"
	tail_type = "Long"
