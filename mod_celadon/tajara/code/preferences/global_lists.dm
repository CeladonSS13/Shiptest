...
GLOBAL_LIST_INIT(tajaran_names_male, world.file2list("mod_celadon/tajaran/strings/tajaran_male_names.txt"))
GLOBAL_LIST_INIT(tajaran_names_female, world.file2list("mod_celadon/tajaran/strings/tajaran_female_names.txt"))
