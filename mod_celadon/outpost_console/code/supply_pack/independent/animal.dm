...
/datum/supply_pack/faction/independent/animal/cat/generate()
	. = ..()
	if(prob(50))
...
/datum/supply_pack/faction/independent/animal/corgi/generate()
	. = ..()
	if(prob(50))
...
/datum/supply_pack/faction/independent/animal/butterfly/generate()
	. = ..()
	for(var/i in 1 to 3)
...
/datum/supply_pack/faction/independent/animal/crab
	name = "Crab Rocket"
...
/datum/supply_pack/faction/independent/animal/crab/generate()
	. = ..()
