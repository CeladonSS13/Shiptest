...
// /mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/update_icons()
...
/mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon
	name = "Hivebot beacon"
	...
	health = 300
	maxHealth = 300
	armor = list("melee" = 55, "bullet" = 50, "laser" = 55, "energy" = 50, "bomb" = 20, "bio" = 0, "rad" = 100, "fire" = 50, "acid" = 0)
	// blood_type = COLOR_OIL
	projectilesound = 'sound/weapons/taser2.ogg'
	projectiletype = /obj/projectile/beam/hivebot_high
	wander = 0
	...
	aggro_blurb = list("focuses on", "INFILTRATOR WITHIN AO!!", "TERMINATE HOSTILE!!", "DEFEND TERMINUS!!", "CODE 1-9-84!!")
	...
	var/list/mob/living/simple_animal/hostile/hivebot/high_alert/linked_bots = list()
...
/mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/Initialize(mapload)
	. = ..()
...
/mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/Destroy()
	//Remove the reference from all linked bots to us
	for(var/mob/living/simple_animal/hostile/hivebot/high_alert/latest_child in linked_bots)
...
// /mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/proc/generate_warp_destinations()
...
// /mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/death()
...
// /mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/think()
// 	. =..()
...
// /mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/MoveToTarget()
...
// /mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/proc/activate_beacon()
// 	if(activated != 1)
// 		if(activated == -1)
// 			return
// 		else
...
// /mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/AirflowCanMove(n)
// 	return 0

// /mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/bullet_act(var/obj/projectile/Proj)
// 	if(istype(Proj, /obj/projectile/bullet/hivebotspike) || istype(Proj, /obj/projectile/beam/hivebot_high))
// 		Proj.no_attack_log = 1
// 		return PROJECTILE_CONTINUE
// 	else
// 		..(Proj)

// /mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/emp_act(severity)
// 	. = ..()
...
// /mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/proc/wakeup()
// 	change_stance(HOSTILE_STANCE_IDLE)
// 	activated = 0
// 	activate_beacon()

// /mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/proc/warpbots()
...
/mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/proc/calc_spawn_delay()
...
/mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/Life()
	..()
	if(wander)
		wander = 0
		stop_automated_movement = 1
...
/mob/living/simple_animal/hostile/hivebot/high_alert/hivebotbeacon/incendiary
	projectiletype = /obj/projectile/beam/hivebot_high/incendiary
