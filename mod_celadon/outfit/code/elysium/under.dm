/obj/item/clothing/under/el_cloth_1
	...
	icon = 'mod_celadon/_storge_icons/icons/items/obj1/el_cloth.dmi'
	mob_overlay_icon = 'mod_celadon/_storge_icons/icons/items/clothing/under/overlay/el_cloth.dmi'
