...
/obj/item/storage/belt/skimitar
	...
	icon = 'mod_celadon/_storage_icons/icons/items/weapons/sheath-skimitar.dmi'
	mob_overlay_icon = 'mod_celadon/_storage_icons/icons/items/weapons/overlay/sheath-skimitar.dmi'
	icon_state = "sheath"
	item_state = "sheath"
