...
/obj/item/clothing/accessory/maidapron
	...
	icon = 'mod_celadon/_storge_icons/icons/items/clothing/obj/accessories.dmi'
	mob_overlay_icon = 'mod_celadon/_storge_icons/icons/items/clothing/overlay/accessories.dmi'
