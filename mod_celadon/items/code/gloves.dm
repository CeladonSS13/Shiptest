/obj/item/clothing/gloves/combat/maid
	...
	icon = 'mod_celadon/_storge_icons/icons/items/clothing/obj/gloves.dmi'
	mob_overlay_icon = 'mod_celadon/_storge_icons/icons/items/clothing/overlay/hands.dmi'
...
/obj/item/clothing/gloves/combat/maid/syndicate
	name = "syndicate combat maid sleeves"
	desc = "These 'tactical' gloves and sleeves are fireproof and electrically insulated. Warm to boot."
	icon_state = "syndimaid_arms"
	item_state = "syndimaid_arms"
