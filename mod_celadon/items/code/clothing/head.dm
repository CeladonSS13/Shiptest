...
/obj/item/clothing/head/costume/tv_head
	...
	icon = 'mod_celadon/_storage_icons/icons/items/clothing/head/costume.dmi'
	mob_overlay_icon = 'mod_celadon/_storage_icons/icons/items/clothing/head/overlay/costume.dmi'
	icon_state = "IPC_helmet"
	item_state = "syringe_kit"
	lefthand_file = 'mod_celadon/_storage_icons/icons/items/misc/in_hands/medical_lefthand.dmi' //Grandfathered in from the wallframe for status displays.
	righthand_file = 'mod_celadon/_storage_icons/icons/items/misc/in_hands/medical_righthand.dmi'
...
/obj/item/clothing/head/beret/dominia
	...
	icon = 'mod_celadon/_storage_icons/icons/items/clothing/head/beret.dmi'
	mob_overlay_icon = 'mod_celadon/_storage_icons/icons/items/clothing/head/overlay/beret.dmi'
