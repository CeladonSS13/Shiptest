...
export const MESSAGE_TYPES = [
  ...
  },
  {
    ...
    selector:
      '.alert, .minorannounce, .syndradio, .centcomradio, .aiprivradio, .emrgradio, .pirradio, .solfedradio, .sunsradio, .voxradio, .ramziradio, .irmgradio, .elysiumradio, .ntradio, .radio, .deptradio, .binarysay, .newscaster, .resonate, .ntradio_short, .sunsradio_short, .irmgradio_short, .syndradio_short, .elysiumradio_short, .solfedradio_short',
  },
  {
